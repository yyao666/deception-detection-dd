...
class Spec_Dataset(Dataset):
    def __init__(self, annotations_file, spec_dir):
        ...
        for i in range(annotations.shape[0]):
            ...
            # if ethnicity == "EA" and language in ["Chinese","chinese"]: # chinese
            # if ethnicity == "EA" and language in ["English","english"]:

            # if ethnicity == "SEA" and language in ["Malay","malay"]: # malay
            # if ethnicity == "SEA" and language in ["English","english"]:

            if ethnicity == "SA" and language in ["Hindi","hindi"]: # hindi
            # if ethnicity == "SA" and language in ["English","english"]:

                self.annos.append(annotations.iloc[i])
...
for fold in range(1,5):
    ...
    train_dataset = Spec_Dataset(train_csv, "/home/DSO_SSD/ROSE_V2/hr_spectrograms/")
    test_dataset = Spec_Dataset(test_csv, "/home/DSO_SSD/ROSE_V2/hr_spectrograms/")
